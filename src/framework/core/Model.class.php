...
class Model{
    ...
    public function __construct($table){
        $dbconfig['DB_SERVER']   = $GLOBALS['config']['DB_SERVER'];
        $dbconfig['DB_USERNAME'] = $GLOBALS['config']['DB_USERNAME'];
        $dbconfig['DB_PASSWORD'] = $GLOBALS['config']['DB_PASSWORD'];
        $dbconfig['DB_NAME']     = $GLOBALS['config']['DB_NAME'];
        $dbconfig['DB_PORT']     = $GLOBALS['config']['DB_PORT'];
        $dbconfig['DB_CHARSET']  = $GLOBALS['config']['DB_CHARSET'];
       
        $this->db = new Mysql($dbconfig);
        $this->table = $table; //$GLOBALS['config']['prefix'] . $table;
        //$this->getFields();
    }
